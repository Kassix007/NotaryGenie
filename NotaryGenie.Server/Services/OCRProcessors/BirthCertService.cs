...
namespace NotaryGenie.Server.Services.OCRProcessors
{
    ...
    public class BirthCertService : IBirthCertService
    {
        private readonly string _projectId;
        private readonly string _location;
        private readonly string _processorId;

        public BirthCertService(IConfiguration configuration)
        {
            _projectId = configuration["GoogleCloud:ProjectId"];
            _location = configuration["GoogleCloud:Location"];
            _processorId = configuration["GoogleCloud:BirthCertProcessorId"];
        }
