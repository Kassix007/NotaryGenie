...
{
    public interface IIdCardBackService
    {
        Task<List<DocumentEntity>> ProcessDocumentAsync(string filePath);
    }

    public class IdCardBackService : IIdCardBackService
    {
        private readonly string _projectId;
        private readonly string _location;
        private readonly string _processorId;

        public IdCardBackService(IConfiguration configuration)
        {
            _projectId = configuration["GoogleCloud:ProjectId"];
            _location = configuration["GoogleCloud:Location"];
            _processorId = configuration["GoogleCloud:IDCardBackProcessorId"];
        }
